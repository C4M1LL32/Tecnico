...
scoreboard players reset @a[x=0,y=52,z=-127,distance=..5,tag=!inRace] time
scoreboard players reset @a[x=0,y=52,z=-127,distance=..5,tag=!inRace] time_tick
tag @a[x=0,y=52,z=-127,distance=..5,tag=!inRace] remove ingame
